        ...
        <section className="min-h-screen flex items-stretch text-white ">
            ...
            >
                <div className="absolute lg:hidden z-10 inset-0 bg-gray-500 bg-no-repeat bg-cover items-center"
                    style={style2}
                // style={{ backgroundImage: `url(https://i.ibb.co/ZNfxmsS/blurred-traffic-light-trails-road.jpg)` }} >
                >

                    <div className="absolute bg-black opacity-60 inset-0 z-0 text-zinc-900"></div>
                </div>
                <div className="w-full py-6 z-20">
                    <h1 className="my-6 text-7xl font-bold">
                        LOGIN
                    </h1>
