  ...
  return (
    <div>
      <h1 class="mb-10 mt-10 text-3xl font-extrabold leading-none tracking-tight md:text-5xl lg:text-5xl text-white">
        Let's Explore <span class="text-blue-600 dark:text-blue-500">The</span>{" "}
        Price.
      </h1>
      <section className="py-6 dark:bg-gray-800 mb-5">
          ...
          <div className="grid max-w-md grid-cols-1 gap-6 mx-auto auto-rows-fr lg:grid-cols-3 lg:max-w-full">
            <div className="flex flex-col overflow-hidden border-2 rounded-md dark:border-gray-700">
              ...
              <div className="flex flex-col items-center justify-center px-2 py-8 dark:bg-gray-900">
                ...
                <button className="border px-8 py-3 mt-6 text-lg font-semibold rounded sm:mt-12 dark:bg-violet-400 dark:text-gray-900">
                  Book
                </button>
              </div>
            </div>
            <div className="flex flex-col overflow-hidden border-2 rounded-md dark:border-violet-400">
              ...
              <div className="flex flex-col items-center justify-center px-2 py-8 dark:bg-gray-900">
                ...
                <button className="px-8 py-3 mt-6 text-lg font-semibold border rounded sm:mt-12 dark:bg-violet-400 dark:text-gray-900">
                  Book
                </button>
              </div>
            </div>
      ...
      <h1 class="mb-10 mt-10 text-3xl font-extrabold leading-none tracking-tight md:text-5xl lg:text-5xl text-white">
        Let's See <span class="text-blue-600 dark:text-blue-500">who we </span>{" "}
        are.
      </h1>
