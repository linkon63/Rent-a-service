    ...
    <div className="bg-slate-900 rounded h-96">
      <div className="flex h-full text-white">
        <div className="flex justify-center items-center md:w-8/12 min-w-fulL">
          <div>
            <h1 class="mb-4 text-3xl font-extrabold  md:text-5xl lg:text-6xl p-2">
              <span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">
                Rental cars
              </span>{" "}
              <br /> can be your experience
            </h1>
            <h1 class="mb-4 text-4xl leading-none tracking-tight md:text-2xl lg:text-2xl text-right">
              Find your{" "}
