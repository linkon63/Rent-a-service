...
export default function CarsServicePage() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      // calling api
      axios
        .get(`http://localhost:8080/serviceData/?id=${routeId}`)
    ...
    <>
      ...
      <div className=" flex justify-center">
        <div className="container">
          <div>
            <h1 class="mb-10 mt-10 text-3xl font-extrabold leading-none tracking-tight md:text-5xl lg:text-5xl text-white">
              Let's Go
                  ...
                  <div className="grid  grid-cols-3 gap-4 pt-2 text-white">
                    {servicesData && servicesData.length ? (
                      servicesData.map((data) => (
                        <div
                          className="max-w-xs shadow border-r-2 rounded-r-lg"
                          key={data.id}
                        >
                          <img
                            src={data.image}
                          ...
                          <div className="flex flex-col justify-between p-6 space-y-8">
                            ...
                            <button
                              type="button"
                              className="flex items-center justify-center w-full p-3 font-semibold tracking-wide rounded dark:bg-violet-400 dark:text-gray-900 border"
                            >
                              <Link
                                to={`/bookingService/${bookingName}/${data.id}`}
                              >
                                Book Now
                              </Link>
                            </button>
                    ...
                    <div className="relative col-span-12 px-4 space-y-6 sm:col-span-9">
                      <div className="col-span-12 space-y-12 relative px-4 sm:col-span-8 sm:space-y-8 sm:before:absolute sm:before:top-2 sm:before:bottom-0 sm:before:w-0.5 sm:before:-left-3 before:dark:bg-gray-700">
                        ...
                        <div className="flex flex-col sm:relative sm:before:absolute sm:before:top-2 sm:before:w-4 sm:before:h-4 sm:before:rounded-full sm:before:left-[-35px] sm:before:z-[1] before:dark:bg-violet-400">
                          ...
                          <p className="mt-3">
                            Suspendisse tincidunt, arcu nec faucibus efficitur,
                            justo velit consectetur nisl, sit amet condimentum
                            lacus orci nec purus. Mauris quis quam suscipit,
